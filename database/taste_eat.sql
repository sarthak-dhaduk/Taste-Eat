...
CREATE TABLE `cancelation_time` (
  `cancelation_id` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `category` (
  `category_id` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
('65f4383ec93ed', 'Chinese'),
('65f438434ed1b', 'Desert'),
('65f43840e0ed8', 'Indian'),
('65f438748ec0d', 'Italian'),
('65f4383c69fbc', 'Maxican');
...
CREATE TABLE `contact_us` (
  `contact_id` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `issue` (
  `issue_id` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `user_name` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `date` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `subject` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `items` (
  `item_id` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
('65ec189b482d3', 'Corn Tortilla (Tortilla de Maíz)', 'Maxican', '65ec189b482d9m6-Corn Tortilla (Tortilla de Maíz).jpg', '56', 'Similar to our makke di roti, these tortillas are made from corn and are often paired with spicy dishes1.'),
...
('65ec1d9522edc', 'Pastel de Belém (Belém, Portugal)', 'Desert', '65ec1d9522ee2d3-Pastel de Belém (Belém, Portugal).jpg', '82', 'A predecessor to pastel de nata, these tarts have a custard filling flavored with lemon and cinnamon.\r\nOnly those produced at Fábrica Pastéis de Belém can be called pastel de Belém.\r\nServed hot or cold, it’s a Portuguese delight1.'),
...
CREATE TABLE `order` (
  `order_id` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `user_name` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `item_name` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `quantity` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `price` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `register` (
  ...
  `user` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `review` (
  `review_id` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `user_name` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `item_name` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `rating` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
ALTER TABLE `contact_us`
  ...
  ADD KEY `Username_relation_4` (`user_name`),
  ADD KEY `Email_relation_4` (`email`);
...
ALTER TABLE `issue`
  ...
  ADD KEY `Username_relation_3` (`user_name`),
  ADD KEY `Email_relation_3` (`email`);
...
ALTER TABLE `items`
  ...
  ADD KEY `Category_relation` (`category`);
...
ALTER TABLE `order`
  ...
  ADD KEY `Username_relation_2` (`user_name`),
  ADD KEY `Email_relation_2` (`email`),
  ADD KEY `Food_Items_relation_2` (`item_name`);
...
--
ALTER TABLE `contact_us`
  ADD CONSTRAINT `Email_relation_4` FOREIGN KEY (`email`) REFERENCES `register` (`email`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Username_relation_4` FOREIGN KEY (`user_name`) REFERENCES `register` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `issue`
--
ALTER TABLE `issue`
  ADD CONSTRAINT `Email_relation_3` FOREIGN KEY (`email`) REFERENCES `register` (`email`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Username_relation_3` FOREIGN KEY (`user_name`) REFERENCES `register` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `items`
--
ALTER TABLE `items`
  ADD CONSTRAINT `Category_relation` FOREIGN KEY (`category`) REFERENCES `category` (`category`) ON DELETE SET NULL ON UPDATE SET NULL;

--
-- Constraints for table `order`
--
ALTER TABLE `order`
  ADD CONSTRAINT `Email_relation_2` FOREIGN KEY (`email`) REFERENCES `register` (`email`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Food_Items_relation_2` FOREIGN KEY (`item_name`) REFERENCES `items` (`item_name`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Username_relation_2` FOREIGN KEY (`user_name`) REFERENCES `register` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `review`
--
ALTER TABLE `review`
  ADD CONSTRAINT `Email_relation` FOREIGN KEY (`email`) REFERENCES `register` (`email`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Food_Items_relation` FOREIGN KEY (`item_name`) REFERENCES `items` (`item_name`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Username_relation` FOREIGN KEY (`user_name`) REFERENCES `register` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
